...
import { getLabelVariableAssignments } from '/public/scripts/clientes/printer-label-preview.js';
let page_oc = 0;
let limit_oc = 5;
...
$('#form_qr_config').on('submit', async function (e) {
    ...
    const labelReplacements = getLabelVariableAssignments();
    console.log({ labelReplacements });
    data.label_replacements = labelReplacements.replacements;
    data.label_id = labelReplacements.label_id;
